    ...
    if (window.confirm('Are you sure you want to delete this patient? This will also delete all their appointments.')) {
      ...
      try {
        ...
        if (response.ok) {
          ...
          setMessage(data.message || 'Error deleting patient');
        }
      } catch (error) {
        setMessage('Error connecting to server');
      } finally {
  ...
  const handleAddUser = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setMessage(data.message || 'Error creating patient');
      }
    } catch (error) {
      setMessage('Error connecting to server');
    } finally {
  ...
  return (
    <div className="dashboard-page">
      ...
      <div className="dashboard-content">
        ...
        {loading && <div className="loading">Please wait, loading patients...</div>}
              ...
              <div className="modal-content" onClick={(e) => e.stopPropagation()}>
                ...
                <form onSubmit={handleAddUser} className="add-user-form">
                  ...
                  <div className="form-actions">
                    ...
                    >
                      {actionLoading.creating ? 'Please wait, creating...' : 'Create Patient'}
                    </button>
                  </div>
                </form>
              </div>
            ...
            <table className="users-table">
              ...
              <tbody>
                {users && users.length > 0 ? users.map(user => (
                  ...
                  <tr>
                    <td colSpan="7" className="no-users">No patients found</td>
                  </tr>
                )}
              </tbody>
            </table>
